...
#pragma warning restore 649
        ...
        public bool Start()
        {
            ...
            _resources.MountContentDirectory(@"../../../../Resources/");
            _resources.MountContentDirectory(@"../../../../../Content.Server.Core/bin/Debug/netcoreapp2.0/", new ResourcePath("/Assemblies/"));
#endif
            ...
            if (!AssemblyLoader.TryLoadAssembly<GameShared>(_resources, $"Content.Shared.Standard"))
            {
                Logger.Warning($"[ENG] Could not load any Shared DLL.");
            }

            if (!AssemblyLoader.TryLoadAssembly<GameServer>(_resources, $"Content.Server.Core"))
            {
